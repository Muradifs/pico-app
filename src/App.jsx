       ...
       {activeTab === 'social' && (
         <div className="animate-in slide-in-from-right duration-300 space-y-4">
           ...
           <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 text-center">
             <p className="text-slate-400 text-xs">Invite more users to increase your mining rate!</p>
             <button className="mt-3 w-full py-2 bg-indigo-600 hover:bg-indigo-700 rounded-lg text-white text-sm font-bold">Invite Friends</button>
           </div>
         </div>
       )}

       {activeTab === 'market' && (
         <div className="animate-in slide-in-from-right duration-300 grid grid-cols-2 gap-4">
           <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 flex flex-col items-center text-center">
             ...
             <button onClick={() => {if(balance >= 1000) {setBalance(b => b-1000); setEnergy(100);}}} className="w-full py-1.5 bg-slate-700 hover:bg-slate-600 rounded text-xs text-white font-bold">
               1,000 Pico
             </button>
           </div>
           <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 flex flex-col items-center text-center opacity-50">
             <Shield className="text-purple-400 mb-2" size={32} />
             <h3 className="text-white font-bold text-sm">Node License</h3>
             <p className="text-slate-400 text-[10px] mb-3">Run a virtual node</p>
             <button className="w-full py-1.5 bg-slate-700 rounded text-xs text-white font-bold cursor-not-allowed">
               Sold Out
             </button>
           </div>
         </div>
